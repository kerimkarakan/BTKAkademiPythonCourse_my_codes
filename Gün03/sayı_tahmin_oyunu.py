...
#versiyon 5 tahmin etmeye devam edebilsin ama aralık daralsın ve sadece daralan aralıkta tahminde bulunsun
#sayi = 35
#taban = 0
#tavan = 100
#print(f"Tahmin edeceğiniz sayı {taban} - {tavan} aralığındadır")
...
#while tahmin != sayi:
 #   if tahmin > sayi:
 #       print("Tahmin Başarısız Keşke küçük bir sayı söyleseydin")
  #      tavan = tahmin # bunu kullanıcıyı bizim sayıya yaklaştırmak için yaptık
   # elif tahmin < sayi:
    #    print("Tahmin Başarısız Keşke büyük bir sayı söyleseydin")
     #   taban = tahmin # bunu kullanıcıyı bizim sayıya yaklaştırmak için yaptık
    #while True:
     #   if taban <= tahmin <= tavan:
      #      print(f"Tahmin geçerli aralıkta")
       #     break
...
# versiyon 6 kullanıcı hangi sayılarda geçersiz tahmin yapıyor ve kaç kere geçersiz tahmin yapmış
sayi = 35
taban = 0
tavan = 100
gecerli = []
