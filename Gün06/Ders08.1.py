...
def kitapTanimla():
    try:
        ...
        return True  # kitap ekleme gerçekleşti mi gerçekleşmedi mi kontrol ediyoruz bunla
    except:
        return False
        ...
        with open("kitaplistesi.json", "r") as dosya:
            ...
            if len(kayitli_kitap_listesi ) == 0:
                ...
                for x, kitap in enumerate(kayitli_kitap_listesi ):
                    print(x+1,kitap["ad"]) #böylece kitapların sayısını verebileceğiz kullanıcıya
